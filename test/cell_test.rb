...
require './lib/cell'
 ...
 class CellTest < Minitest::Test
  ...
  def test_board_result_if_cell_when_fired_upon_and_does_not_contain_ship
    cell_1 = Cell.new("B4")
  ...
  def test_board_results_when_cell_is_not_fired_upon_and_contains_a_ship
    cell_2 = Cell.new("C3")
    cruiser = Ship.new("Cruiser", 3)
  ...
  def test_board_result_when_cell_is_fired_upon_and_contains_ship
    cell_2 = Cell.new("C3")
    cruiser = Ship.new("Cruiser", 3)
    cell_2.place_ship(cruiser)
  ...
  def test_board_result_when_cell_is_fired_upon_and_ship_has_been_sunk
    skip
    cell_2 = Cell.new("C3")
    cruiser = Ship.new("Cruiser", 3)
    cell_2.place_ship(cruiser)
